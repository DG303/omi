...
<Note>
On first access, if no folders exist, system folders (Work, Personal, Social) are automatically created — matching the behavior of the Omi mobile app. These folders correspond to the conversation category tabs shown in the app.
</Note>
